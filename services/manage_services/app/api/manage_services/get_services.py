...
@router.post("/BusServiceCompany/",response_model=List[BusResponse])
...
@router.post("/TrainServiceCompany/",response_model=List[TrainResponse])
...
@router.post("/TourServiceCompany/",response_model=List[TourResponse])
...
@router.post("/AirplaneServiceCompany/",response_model=List[AirplainResponse])
